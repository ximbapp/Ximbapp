            ...
            <Modal visible={editModalVisible} transparent animationType="slide" onRequestClose={() => setEditModalVisible(false)}>
                <View style={globalStyles.modalOverlay}>
                    <View style={[styles.modalContent, { backgroundColor: isDark ? COLORS.darkBg : COLORS.lightBg }]}>
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            <TextInput
                                style={[styles.input, { backgroundColor: isDark ? COLORS.darkCard : COLORS.lightCard, color: COLORS.evento }]}
                            ...
                            />
                            <TextInput
                                style={[styles.input, globalStyles.inputMultiline, { backgroundColor: isDark ? COLORS.darkCard : COLORS.lightCard, color: COLORS.evento }]}
                            ...
                            <TouchableOpacity style={[styles.saveButton, guardandoEdicion && { opacity: 0.7 }]} onPress={handleGuardarEdicion} disabled={guardandoEdicion}>
                                <Text style={globalStyles.btnPrimaryText}>{guardandoEdicion ? "Guardando..." : "Guardar cambios"}</Text>
                            </TouchableOpacity>
                        </ScrollView>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    header: {
        ...
        paddingBottom: 12,
        borderBottomWidth: 1,
        borderBottomColor: COLORS.evento,
    },
